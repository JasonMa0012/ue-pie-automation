...
public:
	...
	static TSharedPtr<FJsonValue> PieReferenceSave(const TSharedPtr<FJsonObject>& Params);
	static TSharedPtr<FJsonValue> PieFrameDiff(const TSharedPtr<FJsonObject>& Params);

...
namespace UE_PIE_Automation
{
	namespace TakeRecorderBridge
	{
		...
		bool StartFromPanel(FString& OutMessage)
		{
			...
			UE_LOG(LogUE_PIE_Automation, Log, TEXT("[PIE-REC] Take Recorder StartRecording dispatched"));
			return true;
		}
		...
		bool StopFromPanel(FString& OutMessage)
		{
			...
			UE_LOG(LogUE_PIE_Automation, Log, TEXT("[PIE-REC] Take Recorder StopRecording dispatched"));
			return true;
		}
	}
}

...
namespace UE_PIE_Automation
{
	...
	struct FCSVRow
	{
		...
		// Viewport-local cursor position sampled independently of Enhanced Input.
		// This remains useful when the game releases the cursor and no move event
		// is generated, while a controller polls the position from Tick.

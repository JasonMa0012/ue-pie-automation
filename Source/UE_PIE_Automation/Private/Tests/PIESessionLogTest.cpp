...
//   Automation RunTests UE_PIE_Automation.SessionLog
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UE_PIE_Automation.SessionLog.CapturesErrorsAndWritesArtifacts",
...
bool FPIESessionLogCaptureTest::RunTest(const FString& /*Parameters*/)
{
	...
	const FName Cat(TEXT("LogUE_PIE_Automation"));

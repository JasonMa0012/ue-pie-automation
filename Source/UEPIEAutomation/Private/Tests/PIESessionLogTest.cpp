...
//   Automation RunTests UEPIEAutomation.SessionLog
// Runs as a native UE Automation test in the host project.
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UEPIEAutomation.SessionLog.CapturesErrorsAndWritesArtifacts",
...
bool FPIESessionLogCaptureTest::RunTest(const FString& /*Parameters*/)
{
	...
	const FName Cat(TEXT("LogUEPIEAutomation"));

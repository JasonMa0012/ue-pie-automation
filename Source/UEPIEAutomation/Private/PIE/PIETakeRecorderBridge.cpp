...
namespace UEPIEAutomation
{
	namespace TakeRecorderBridge
	{
		...
		bool StartFromPanel(FString& OutMessage)
		{
			...
			UE_LOG(LogUEPIEAutomation, Log, TEXT("[PIE-REC] Take Recorder StartRecording dispatched"));
			return true;
		}
		...
		bool StopFromPanel(FString& OutMessage)
		{
			...
			UE_LOG(LogUEPIEAutomation, Log, TEXT("[PIE-REC] Take Recorder StopRecording dispatched"));
			return true;
		}
	}
}
